...
from preprocessing_tools.leadspotting_campaign_details_importer import CampaignDetailsImporter
...
modules_dict["CampaignDetailsImporter"] = CampaignDetailsImporter
